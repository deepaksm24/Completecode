...
const NewProject = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const NewProjectObject = {
      ...
      SoftwareRevision: formData.softwareVersion,
      MajorRev: formData.softwareVersion,
      Major: formData.softwareVersion,
    ...
    if (foundController) {
      ...
      console.log(NewProjectFinalObject);
    ...
    try {
      ...
      // const serverResponse = await submitFormData(formData);
